    ...
    <div className="relative min-h-full">
      ...
      <div className="space-y-3 max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="inline-flex items-center rounded-xl border border-white/40 dark:border-white/10 bg-white/60 dark:bg-white/5 px-4 py-2 backdrop-blur shadow-sm">
            <h1 className="text-xl font-bold text-[#0a2e3c] dark:text-white">Tickets</h1>
          </div>
